...
```json
{
  ...
  "layers": {
    "longterm": {
      "content": "<full text of LTMEMORY.md>",
      "metadata": {
        "lines": 142,
        "entries": 45,
...
|-----|---------------|-------------|
| `longterm` | `LTMEMORY.md` | Long-term structured knowledge (Auto-Dream layer) |
...
Copy into it:
  - LTMEMORY.md → pre-import-backup-*/LTMEMORY.md
...
#### longterm (LTMEMORY.md) merge

1. Parse entries from both source (current LTMEMORY.md) and bundle content
...
4. Write the merged LTMEMORY.md
